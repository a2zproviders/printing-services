        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <button class="btn btn-primary" data-toggle="collapse" data-target="#state_box">+ Add</button>
                </div>

                <!-- Card Body -->
                <div class="card-body collapse" id="state_box">
                  {!! Form::open(['method' => 'POST', 'action' => 'admin\StateController@store', 'class' => 'user']) !!}
                  @include('admin.template._state_form')
                  <div class="text-right">
                    <input type="submit" class="btn btn-primary" name="add" value="Add State" />
                  </div>
                  {!! Form::close() !!}
                </div>
              </div>
            ...
            <div class="col-xs-12 col-lg-12">
              {{ Form::open(['url' => url(env('ADMIN_DIR').'/state/')]) }}
              <div class="card">
                  ...
                  <table class="table table-bordered table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr class="bg-light">
                        ...
                        <td><a href="{{route('state.edit', $list->id) }}"><i class="far fa-edit" aria-hidden="true"></i> {{$list->name}}</a></td>
                        <td>{{$list->slug}}</td>
